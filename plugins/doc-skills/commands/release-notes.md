---
description: Generate clean, grouped release notes from a changelog, git log, or list of changes.
---

Read the source material at $ARGUMENTS (a changelog, git log, or list of changes) and generate release notes. (Generator pattern.)
